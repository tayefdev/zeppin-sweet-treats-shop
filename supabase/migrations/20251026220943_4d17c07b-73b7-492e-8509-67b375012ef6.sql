...
DROP POLICY IF EXISTS "Admin can insert bakery items" ON public.bakery_items;
CREATE POLICY "Admin can insert bakery items"
ON public.bakery_items FOR INSERT
TO authenticated
WITH CHECK (public.has_role(auth.uid(), 'admin'));

DROP POLICY IF EXISTS "Admin can update bakery items" ON public.bakery_items;
...
DROP POLICY IF EXISTS "Admin can delete bakery items" ON public.bakery_items;
...
DROP POLICY IF EXISTS "Admin can manage banners" ON public.banner_settings;
...
DROP POLICY IF EXISTS "Admin can insert global sales" ON public.global_sales;
CREATE POLICY "Admin can insert global sales"
ON public.global_sales FOR INSERT
TO authenticated
WITH CHECK (public.has_role(auth.uid(), 'admin'));

DROP POLICY IF EXISTS "Admin can update global sales" ON public.global_sales;
...
DROP POLICY IF EXISTS "Admin can delete global sales" ON public.global_sales;
...
DROP POLICY IF EXISTS "Admin can manage banners storage" ON storage.objects;
DROP POLICY IF EXISTS "Admin can manage bakery items storage" ON storage.objects;
DROP POLICY IF EXISTS "Public can view banners" ON storage.objects;
DROP POLICY IF EXISTS "Public can view bakery items" ON storage.objects;
